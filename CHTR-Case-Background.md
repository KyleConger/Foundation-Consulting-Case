...
|---|---|---|
| Week 1 (Thu 8/20) | Kickoff | Teams formed; brief distributed |
| Week 3 | Check-in #1 | Problem definition, issue tree / hypotheses |
| Week 5 | Check-in #2 | Analysis of data pack + client-ready viz |
| Week 7 | Final presentation | Full client pitch |
| **Sun 9/27, 11:59pm ET** | Deck due in Canvas | Final PowerPoint |

**Grading (40 of 100 course points).** Problem definition 10 · Support for recommendation 10 · Actionability 10 · Individual contribution 10. Each of the first three: 7.5 instructor + 2.5 peer. Individual: 5 instructor + 5 peer.
...
| Major shareholders | Historically Liberty Broadband and Advance/Newhouse (A/N); being restructured via pending Liberty + Cox deals |

---

## 4. Products (what they sell)
...
- **Spectrum Enterprise.** Up to 100 Gbps; Ethernet, SD-WAN, cloud, security, trunking; hospitality/healthcare/gov/education video.
- **Spectrum Reach.** Local/regional/national ads; up to 100 channels in 90+ markets; interconnects.
- **Other.** RSNs (Lakers through 2032; Dodgers affiliate; 35% SNY/Mets); 35+ local news (NY1, SoCal); Community Solutions (MDUs, student/senior, RV; up to 2 Gbps).

---

## 5. Must-know numbers

### FY snapshot (Charter consolidated)

| Metric | FY2023 | FY2024 | FY2025 |
|---|---:|---:|---:|
| Total revenue ($M) | 54,607 | 55,085 | **54,774** (−0.6% YoY) |
| Adjusted EBITDA ($M) | n/a* | 22,569 | **22,708** (+0.6%) |
| Net income to CHTR ($M) | n/a* | 5,083 | **4,987** |
| Diluted EPS | — | $34.97 | **$36.21** (+4%; buybacks) |
| Diluted shares | — | 145.4M | **137.7M** |
| Free cash flow ($M) | n/a* | 4,257 | **5,004** (+18%) |
| Capex ($M) | n/a* | 11,269 | **11,659** |
| Customer relationships (000s) | 32,126** | 32,214 | **31,846** |
| Internet customers (000s) | 30,588** | 30,083 | **29,680** (−403k / −1.3%) |
| Mobile lines (000s) | 7,766** | 9,858*** | **11,766*** (+1.9M / +19%) |

\*FY2023 EBITDA/NI/FCF/capex not comparable (CCO Holdings vs. Charter consolidated). \*\*Old customer methodology. \*\*\*Restated basis.

### FY2025 customers vs. 2024 (restated; thousands)

| Category | 2025 | 2024 | Change |
|---|---:|---:|---:|
| Residential relationships | 29,609 | 29,964 | −355 (−1.2%) |
| Small business relationships | 2,237 | 2,250 | −13 |
| **Total relationships** | **31,846** | **32,214** | **−368 (−1.1%)** |
| Residential ARPU / month | $119.05 | $118.71 | +$0.34 |
| Total Internet | 29,680 | 30,083 | **−403 (−1.3%)** |
| — Residential Internet | 27,641 | 28,034 | −393 |
| Total mobile lines | 11,766 | 9,858 | **+1,908 (+19.4%)** |
| Total video | 12,605 | 12,892 | −287 (−2.2%) |
| Total voice | 6,046 | 6,884 | −838 (−12.2%) |
| Mid-market & large PSUs | 357 | 340 | +17 (+5%) |

**Read:** Internet = profit engine and it is shrinking (single most important operating trend). Mobile = growth engine, lower-margin, deepens bundles. Video/voice = secular decline. ARPU ~flat (~$119) by design (simpler/lower promo pricing). Bad-debt 60+ days improved (~82.3k vs ~102.5k). SMB ~2.2M; commercial smaller, steadier, growing.

### Revenue mix ($M)

| Line | 2025 | 2024 | 2023 | ’25 vs ’24 |
|---|---:|---:|---:|---:|
| Internet | 23,765 | 23,360 | 23,032 | +1.7% |
| Mobile service | 3,762 | 3,083 | 2,243 | **+22.0%** |
| **Connectivity (Internet + mobile)** | **27,527** | **26,443** | — | **+4.1%** |
| Video | 13,703 | 15,129 | 16,351 | **−9.4%** |
| Voice | 1,350 | 1,437 | 1,510 | −6.0% |
| Residential total | 42,580 | 43,009 | 43,136 | −1.0% |
| Small business | 4,346 | 4,376 | 4,353 | −0.7% |
| Mid-market & large | 2,969 | 2,878 | 2,770 | +3.2% |
| Commercial total | 7,315 | 7,254 | 7,123 | +0.9% |
| Advertising | 1,468 | 1,780 | 1,551 | −17.6% (odd-year political trough) |
| Other | 3,411 | 3,042 | 2,797 | +12.1% |
| **Total** | **54,774** | **55,085** | **54,607** | **−0.6%** |

Connectivity (Internet + mobile) is now **>$27.5B, more than half of revenue** — the strategic core. Internet revenue can still rise while subs fall (pricing/mix) — until Q1 2026, when Internet *revenue* also fell.

### P&L, FCF, balance sheet (FY2025 vs FY2024, $M)

- Op costs 32,739 (vs 33,167) · D&A 8,711 · Op income 12,908 · **Interest (5,042)** · NI to CHTR 4,987
- Adj. EBITDA 22,708 · Op. cash 16,077 · PP&E (11,659) · **FCF 5,004**
- Cash 477 · PP&E 46,444 · Franchises 67,471 · Goodwill 29,710 · **Assets 154,213**
- LT debt 94,006 + current 750 · **~95–96B debt vs ~20.5B equity** · CHTR equity 16,054
- **Leverage is the defining BS feature.** Interest ~$5B/year is a major cash claim; rates/refinancing are live risk.
...
|---|---:|---:|
| CPE | 2,260 | 2,172 |
| Scalable infrastructure | 1,536 | 1,422 |
| Upgrade/rebuild | 1,937 | 1,771 |
| Support capital | 1,986 | 1,688 |
| Capex ex line extensions | 7,719 | 7,053 |
| Subsidized rural line extensions | 2,202 | 2,144 |
| Other line extensions | 1,738 | 2,072 |
| **Total capex** | **11,659** | **11,269** |
| Of which rural initiative | 2,208 | 2,152 |
| Of which commercial | 1,201 | 1,437 |
| Of which mobile | 267 | 245 |

**FY2026 capex guide: ~$11.4B excluding Cox.** Network-evolution completion targeted **end of 2027** is the catalyst investors watch for capex to step down and FCF to inflect up.

---

## 6. Q1 2026 — the quarter that crystallized the bear case

| Metric | Mar 31, 2026 | Dec 31, 2025 | Mar 31, 2025 | Notes |
|---|---:|---:|---:|---|
| Customer relationships (000s) | 31,683 | 31,846 | 32,160 | −163 sequential |
| **Internet customers** | **29,560** | **29,680** | **30,024** | **−120k in quarter; −464k YoY** |
| Mobile lines | 12,134 | 11,766 | 10,365 | +368k qtr; +~1.7M YoY |
| Video | 12,545 | 12,605 | 12,711 | −60k (losses moderating) |
| Voice | 5,872 | 6,046 | 6,606 | −174k |
| Residential ARPU | $118.44 | $119.05 | $120.07 | Lower-promo strategy |

| Line ($M) | Q1 2026 | Q1 2025 | Change |
|---|---:|---:|---:|
| Total revenue | 13,597 | 13,735 | **−1.0%** |
| — Internet | 5,852 | 5,930 | **−1.3%** (revenue now falling, not just subs) |
| — Mobile service | 1,052 | 914 | +15.1% |
| — Video | 3,252 | 3,580 | −9.2% |
| — Advertising | 358 | 340 | +5.3% |
| **Adjusted EBITDA** | **5,637** | **5,763** | **−2.2%** (reversal from FY2025 flat) |
| NI to CHTR | 1,163 | 1,217 | −4.4% |
| Capex | 2,855 | 2,399 | **+19%** (CPE +41%, upgrade/rebuild +71%) |
| FCF | 1,372 | 1,564 | **−12%** |

- Leverage: **4.15x** net debt / TTM Adj. EBITDA at 3/31/26. Plan: stay near midpoint of **4.0–4.5x** until Cox close, then long-term target **3.5–3.75x**.
- Buybacks: ~4.3M shares / ~$1.0B in Q1 2026; remaining board auth ~$179M (ex Liberty purchases). A/N suspended standing repurchase (Aug 2025) pending Cox close.
- Management: competitive environment “continued to challenge Internet customer growth”; principal broadband competitors = **FWA + fiber overbuilders**. Video/voice losses credited to bundling. Housing market slowdown = fewer moves / new signups.

**Bottom line of the quarter:** profit engine kept shrinking, EBITDA turned negative YoY, capex/FCF moved the wrong way — even as mobile grew and video/voice losses moderated. That combination is what a team advising the CEO on “changing the trajectory” must grapple with.

---

## 7. Competition and network (why broadband is shrinking)
...
**Strategic picture:** simultaneously defending broadband against fiber + FWA, monetizing mobile as an MVNO *against the same carriers*, and managing structurally declining video.

**Network.** National IP backbone + regional/metro + last-mile mostly **HFC** (fiber to node, coax to home) branded “fiber-powered network.” New rural/MDU builds typically all-fiber; mid-market/enterprise fiber-to-premises.

**Network evolution (the big capital story).** Upgrade HFC for symmetrical multi-gig: spectrum to 1.2 then 1.8 GHz, high-split upstream, DAA, **DOCSIS 4.0**. Targeted **largely complete by end of 2027**. Designed to answer fiber/FWA at lower incremental cost than full fiber overbuild. May **blunt but not eliminate** those forces.

**WiFi / 5G offload.** ~500M devices on-net. WiFi 7. Targeted 5G small cells using **210 CBRS PALs** + HFC for backhaul/power — to offload MVNO traffic onto owned infrastructure and improve mobile economics.

**Rural construction.** Since early 2022: **$7.7B spent**, ~**1.3M passings** activated, targeting **>1.7M**; **>$8B** total expected; **>$2B** subsidies (RDOF, BEAD, other). “Infrastructure-style returns.” Pole permitting and subsidy milestones (penalties for misses) are execution risks.

---

## 8. Operating nuances (easy to get wrong)

- **Customer methodology change (Q4 2025):** include all mobile (incl. mobile-only); add “total connectivity customers”; some SMB/mid-market defs standardized; priors restated. Example: FY2024 residential relationships **29,258 old vs. 29,964 restated**. Do not mix bases.
...
## 9. Pending transactions (reset scale, ownership, leverage)

Two interrelated deals, expected to close **contemporaneously**, Cox targeted **mid-2026**.

**Cox (announced May 16, 2025).** Combine with Cox Communications (residential cable) + acquire Cox commercial fiber and managed IT/cloud. Consideration includes **$3.5B cash** for equity, plus (FY2025 10-K) **$500M cash** for contribution, **$6.0B convertible preferred** (6.875% dividend, $477.41 conversion), **~33.6M Charter Holdings common units**, 1 share of new Class C. Combined entity assumes **~$12.6B Cox net debt** (FY2025 10-K; Q1 2026 10-Q updates some figures). Cox Enterprises becomes a major long-term shareholder. Would make Charter **#1 U.S. cable operator**.

**Liberty Broadband Combination (announced Nov 12, 2024).** Acquire Liberty Broadband, whose principal asset is **~41.5M Charter shares** (exchange 0.236 CHTR Class A per Liberty share). Simplifies ownership. Liberty spun off GCI Alaska (completed Jul 14, 2025).

These deals **increase scale and footprint, consolidate ownership, and add debt** — raising the stakes on the same broadband-vs-competition question.

---

## 10. Implications the team must define (neutral; not a recommendation)

1. Core asset is a **cash-generative but slow/declining** connectivity business with **heavy leverage and heavy capex**.
2. Broadband erosion is driven by **two durable forces (fiber + FWA)** that a network upgrade may blunt but not eliminate.
